...
@REM set VENV_ACTIVATE_SCRIPT="C:\Users\yaswa\OneDrive\Desktop\Local Host\Ai-Tutor\backend\venv\Scripts\activate.bat"
@REM set BACKEND_DIR="C:\Users\yaswa\OneDrive\Desktop\Local Host\Ai-Tutor\backend"
@REM set UVICORN_EXE="C:\Users\yaswa\OneDrive\Desktop\Local Host\Ai-Tutor\backend\venv\Scripts\uvicorn.exe"
set VENV_ACTIVATE_SCRIPT="Look in the venv file its in Bat Format. Look at above example"
set BACKEND_DIR="Backend repository look above for reference"
set UVICORN_EXE="file format uvicorn.exe look in venv and see above for reference"
